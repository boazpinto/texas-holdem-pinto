...
const playerSchema = new mongoose.Schema({
  ...
  playerSchema.methods.correctPassword=async function(candidatePassword,userPassword){
    return await bcrypt.compare(candidatePassword,userPassword);
  }
  playerSchema.methods.passwordChangedAfter=(function(TWTTimeStamp){
  ...
  playerSchema.methods.createResetToken= function(){
  ...
  //query middleware
  playerSchema.pre(/^find/,function(next){ // we use here a regular expression by the / /
