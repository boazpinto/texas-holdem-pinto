...
//ROUTERS
app.use('/',viewRouter);
app.use('/login/login',viewRouter);
app.use('/me/me',viewRouter);
app.use('/me/scores',viewRouter);
app.use('/:quarter',viewRouter);
app.use('/game/:date',viewRouter);
app.use('/api/v1/player', playerRouter);
app.use('/api/v1/score', scoreRouter);
app.use('/api/v1/score/:id', scoreRouter);
